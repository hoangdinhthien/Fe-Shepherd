            ...
            {selectedItem && (
                <div className='p-4'>
                    ...
                    <Title level={3}>
                        ...
                        <EditOutlined onClick={onUpdateClicked} className="text-blue-500 ml-4 cursor-pointer p-2 rounded-xl hover:bg-blue-gray-300 hover:text-white" />
                    </Title>
                    ...
                    {showCreateActivity && isUpdate && (
                        <div className='flex flex-col gap-2 w-full mt-4'>
                            <p className='font-semibold text-lg text-[#D9D9D9] text-center border-t-2 pt-2 mx-20 border-dashed uppercase'>Update Event</p>
                            <form className='flex flex-col w-full'>
                                <p className='font-semibold m-2'>Event Name</p>
                                <input
                                    required
                                    name='eventName'
                                ...
                                <div className='flex flex-row justify-end items-end w-full gap-4 mt-4'>
                                    <button
                                        onClick={() => {setShowCreateActivity(false); setIsUpdate(false)}}
