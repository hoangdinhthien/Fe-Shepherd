        ...
        <div className='p-4'>
          ...
          <Title level={3}>
            ...
            <EditOutlined
              ...
              className='text-blue-500 ml-4 cursor-pointer p-2 rounded-xl hover:bg-blue-gray-300 hover:text-white'
            />
          </Title>
          ...
          <div className='flex w-full justify-between items-center'>
            ...
            >
              Đi tới{' '}
              {activeTab === 'events'
                ? 'Hoạt Động của Sự Kiện này'
                : 'Nhiệm vụ của Hoạt Động này'}
            </a>
            {activeTab === 'events' &&
              !showCreateActivity &&
              groupIds.length > 0 && (
          ...
          {showCreateActivity && isUpdate && (
            <div className='flex flex-col gap-2 w-full mt-4'>
              ...
              <form className='flex flex-col w-full'>
                <p className='font-semibold m-2'>Tên Sự Kiện</p>
                <input
                  required
                  name='eventName'
                ...
                />
                <p className='font-semibold m-2'>Mô Tả Sự Kiện</p>
                <textarea
                  required
                  name='description'
